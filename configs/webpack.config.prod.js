...
const editorConfig = commonConfig.length === 3 ? commonConfig[2] : {};

module.exports = [ merge(commonConfig[0], prodConfig), merge(commonConfig[1], previewProdConfig), editorConfig ];
